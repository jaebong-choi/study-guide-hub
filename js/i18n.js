...
const I18N = {
    ko: {
        ...
        bannerUsTitle: "미국 대학교 126곳",
        bannerUsSub: "아이비리그부터 패스웨이(조건부입학) 제휴 대학까지, QS 순위·IELTS 기준·진학 경로를 정리했습니다.",
    ...
    en: {
        ...
        bannerUsTitle: "126 US universities",
        bannerUsSub: "From the Ivy League to the conditional-entry pathway partners: QS ranks, IELTS levels and routes in.",
