# 공학 계열 세부전공 — 진단 카드용 확정 데이터 (2026-08-03)

학비는 **CRICOS 등록부**, 영어는 각 대학 공식 문서(`au-english-general.md`),
석사 지원 자격은 각 과정 페이지 원문에서 확인했다.

계열 구성: 공학 일반(기존) · 토목·건설 · 건축 · 기계·전기 · 항공

## 토목·건설 (Civil & Construction)
...
⚠ **건축은 학사만으로 끝나지 않는다.** 등록 건축사로 가려면 **학사 3년 + 석사 2년**이 기본이고,
UQ 석사는 호주건축가협회·퀸즐랜드 건축사위원회 인증이라고 페이지에 명시돼 있다.
학부만 보고 3년으로 계산하면 예산이 2년치 어긋난다.
...
CRICOS를 전수로 뒤졌더니 Quantity Surveying 이름이 붙은 학위는 **본드대(72,300)와 QUT 복수학위**
둘뿐이다. **검증 대상 학교 중에는 하나도 없다.** 그래서 적산은 세부 전공으로 세우지 않고,
가장 가까운 **건설관리(Construction Management)** 를 토목·건설 안에 넣었다.
본드대·QUT의 영어 요건을 확인하면 그때 독립시키면 된다.

## 미검증 (넣지 말 것)

모나쉬 · 멜버른대 · RMIT · QUT · 디킨 · 커틴 · 스윈번 · 애들레이드 · ANU · UOW · 맥쿼리 ·
그리피스 대학원(코스 페이지 403이라 지원 자격을 못 읽는다) · ECU · 본드.
