...
**조사만 하면 되는 것**
- **학부 학비 전수 검증** — 허브 `tuition_ug_min/max` 49곳 값이 미검증이다. 석사 38건 때처럼
  대학 공시와 대조해야 한다. 파운데이션 4곳이 다 맞았으니 UG도 크게 틀리진 않을 것으로 보이나
  확인은 필요하다. 끝나면 진단 UG 결과의 학비 표(commit 7fa8ff5)까지 같이 정리된다.
