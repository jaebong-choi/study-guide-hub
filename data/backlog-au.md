...
### 🔴 발행된 글이 카드 정정을 따라오지 않았다 — 다음 세션 최우선

카드는 고쳤는데 **글 본문 표가 옛 숫자를 그대로 들고 있다.** 확인된 것만:

| 글 | 옛 숫자 | 맞는 값 |
|---|---|---|
| `life-entry` | 플린더스 생명공학 38,300 · 의료공학 40,400 · UQ 생명공학 44,500 · UQ 생체공학 50,100 | 46,000 · 47,800 · 60,952 · 60,952 |
| `med-tests` | UQ 치의학 85,200 · UQ 수의학 76,700 · 시드니 수의학 84,200 | 99,600 · 89,712 · 80,500 |
| `teaching-english` | 유아교육 학사 35,600 / 33,200 · 석사 33,700 | 35,700 / 35,700 · 38,100 |

`hospitality`의 호텔스쿨 34,500은 이번에 26,000으로 고쳤다.
⚠ **표만 고치면 안 된다** — 본문 문장이 숫자를 인용하는 글이 있으니 축이 살아 있는지 같이 볼 것.
`au-*-verified.md`도 같은 이유로 뒤처져 있었고 이번에 UQ·플린더스 행을 함께 맞췄다.
