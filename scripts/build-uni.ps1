...
{{VIDEO_SECTION}}{{EDITOR_NOTE_SECTION}}{{RELATED_SECTION}}
    ...
    var PW_GUIDES = {
        'au-foundation': {
            ko: { t: '파운데이션(대학예비과정)이란?', b: ['고교 성적이나 영어가 대학 직접 입학 기준에 조금 못 미쳐도, 대학 부설 기관에서 8개월~1년간 영어와 전공 기초를 이수한 뒤 수료 성적으로 본교 1학년에 진학하는 경로입니다.', '내신 부담이 컸던 학생이 상위권 대학으로 재도전하는 대표 루트로, 수료 기준(성적·출석)을 충족하면 진학이 보장되는 과정도 많습니다. 보통 IELTS 5.5 수준부터 시작할 수 있습니다.'] },
            en: { t: 'What is a foundation year?', b: ['A university-run preparatory course (8 months to a year) combining English with academic subjects, leading into Year 1 on completion grades, even if your school grades or English fall short of direct entry.', 'Many programs guarantee progression once you meet the completion criteria. Entry typically starts from around IELTS 5.5.'] }
        },
        'au-diploma': {
            ko: { t: '디플로마 편입이란?', b: ['학부 1학년 과목을 대학 부설 컬리지에서 소규모 수업으로 이수한 뒤, 기준 성적(보통 60~70%)을 충족하면 본교 2학년으로 편입하는 경로입니다.', '파운데이션보다 빠르게 학위를 마칠 수 있고 1학년 학비도 절감됩니다. 보통 IELTS 5.5~6.0 수준부터 지원할 수 있으며, 학교·전공별 편입 인정 범위가 다르니 상세 요건은 진단에서 확인하세요.'] },
            en: { t: 'What is a diploma transfer?', b: ['You complete first-year subjects at the university’s college in smaller classes, then transfer into Year 2 once you meet the grade threshold (usually 60–70%).', 'It is faster than a foundation route and saves first-year fees. Entry typically starts around IELTS 5.5–6.0; credit recognition varies by school and course.'] }
        },
        'uk-foundation': {
            ko: { t: '파운데이션(Foundation)이란?', b: ['영국 학부는 13년제 교육(A-level)을 전제로 하기 때문에, 한국 고교 졸업생은 보통 파운데이션 1년을 거쳐 학부 1학년으로 진학합니다.', '대학 부설 또는 제휴 기관에서 영어와 전공 기초를 이수하며, 수료 성적을 충족하면 진학이 보장되는 과정이 많습니다. 보통 IELTS 5.0~5.5 수준부터 시작할 수 있습니다.'] },
            en: { t: 'What is a foundation year?', b: ['UK degrees assume 13 years of schooling (A-levels), so Korean high-school graduates usually take a one-year foundation before entering Year 1.', 'Run by the university or a partner provider, it combines English with academic subjects, and many programs guarantee progression on completion grades. Entry typically starts from around IELTS 5.0–5.5.'] }
        },
        'ca-pathway': {
            ko: { t: '패스웨이 컬리지 편입이란?', b: ['FIC(SFU)·ICM(매니토바)처럼 대학 캠퍼스 안에 있는 패스웨이 컬리지에서 학부 1학년 과정(UTP)을 소규모 수업으로 이수하고, 기준 성적을 충족하면 본교 2학년으로 편입하는 경로입니다.', '직접 입학보다 낮은 성적·영어(보통 IELTS 5.5 수준)로 시작할 수 있고, 수업은 본교와 같은 캠퍼스에서 진행됩니다.'] },
