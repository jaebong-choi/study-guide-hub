...
{{VIDEO_SECTION}}{{EDITOR_NOTE_SECTION}}{{RELATED_SECTION}}
    ...
    // 경로 키 → 국가별 전체 가이드 페이지
    var PW_GUIDE_PAGE = { 'au-foundation': '../guide/au.html', 'au-diploma': '../guide/au.html', 'uk-foundation': '../guide/uk.html', 'ca-pathway': '../guide/ca.html' };
...
$locs = @('', 'privacy.html', 'guide/uk.html', 'guide/au.html', 'guide/ca.html') + $listLocs + ($allIds | ForEach-Object { 'uni/' + $_ + '.html' })
